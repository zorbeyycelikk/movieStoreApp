...
public class GetUserFavoriteMovieGenresByIdQueryTest : IClassFixture<CommonTextFixture>
{
    private readonly VkDbContext dbContext;
    private readonly IMapper mapper;
    private readonly UnitOfWork unitOfWork;
    
    public GetUserFavoriteMovieGenresByIdQueryTest(CommonTextFixture textFixture)
    {
    ...
    [InlineData(345)]
    [InlineData(6789)]
    public async  void WhenNonExistentValueIsGivenToGetUserFavoriteMovieGenresById_ResponseMessageError_ShouldBeReturn(int id)
    {
        // arrange( hazırlık)
        
        // act(çalıştırma)
        var command = new UserFavoriteMovieGenresQueryHandler(mapper, unitOfWork);
